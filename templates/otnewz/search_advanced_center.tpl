	<div class="xFolkHeader">
		<h2 class="xFolkHeaderTitle">{#PLIGG_Visual_Search_Advanced#}</h2>
	</div>
	<div id="advancedSearch" class="contentBlock contentBlockSpace">
		...
		{/literal}
		<form method="get" action="{$URL_search}" {php}	global $URLMethod; if ($URLMethod==2) print "onsubmit='SEO2submit(this); return false;'";{/php}>
			...
			<div class="form-actions">
				...
				<input name="advancesearch" value="Search " type="submit" class="button buttonAction" />
			</div>			
		</form>
	</div>